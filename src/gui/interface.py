...
class MyApp(QWidget):
    def __init__(self):
        ...
        self.proxy_check_box.clicked.connect(self.evt_use_proxy)
    ...
    def evt_set_settings(self):
        ...
        self.settings['bright_data_proxy'] = self.bright_data_proxy_check_box.isChecked()
    ...
    def evt_use_proxy(self):
        if self.proxy_check_box.isChecked() or self.bright_data_proxy_check_box.isChecked():
            self.proxy_path_btn.setEnabled(True)
        elif not self.proxy_check_box.isChecked() and not self.bright_data_proxy_check_box.isChecked():
            self.proxy_path_btn.setEnabled(False)
